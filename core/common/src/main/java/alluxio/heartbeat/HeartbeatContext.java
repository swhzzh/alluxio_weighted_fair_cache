...
public final class HeartbeatContext {
  ...
  public static final String WORKER_BLOCK_SPACE_UPDATER = "Worker Block Space Updater";
  public static final String WORKER_USER_SPACE_REPORTER = "Worker User Space Reporter";
  public static final String WORKER_USER_WEIGHTS_SYNC = "Worker User Weights Sync";
  ...
  static {
    ...
    sTimerClasses.put(WORKER_BLOCK_SPACE_UPDATER, SLEEPING_TIMER_CLASS);
    sTimerClasses.put(WORKER_USER_SPACE_REPORTER, SLEEPING_TIMER_CLASS);
    sTimerClasses.put(WORKER_USER_WEIGHTS_SYNC, SLEEPING_TIMER_CLASS);
