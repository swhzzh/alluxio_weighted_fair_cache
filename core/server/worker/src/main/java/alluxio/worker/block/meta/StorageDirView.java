...
public abstract class StorageDirView {
  ...
  public TempBlockMeta createTempBlockMeta(long sessionId, long userId, long blockId, long initialBlockSize) {
    return new TempBlockMeta(sessionId, userId, blockId, initialBlockSize, mDir);
  }
