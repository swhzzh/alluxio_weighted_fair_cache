...
public final class FileSystemMasterClient extends AbstractMasterClient {
  ...
  public Map<Long, Double> getUserWeights(long workerId) throws AlluxioStatusException {
    return retryRPC(() -> mClient
        .getUserWeights(GetUserWeightsRequest.newBuilder().setWorkerId(workerId).build()).getUserWeightsMap());
  }
