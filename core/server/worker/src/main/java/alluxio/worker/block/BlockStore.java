...
public interface BlockStore extends SessionCleanable {
  ...
  void commitUserBlock(long sessionId, long userId, long blockId, boolean pinOnCreate)
      throws BlockAlreadyExistsException, BlockDoesNotExistException, InvalidWorkerStateException,
      IOException, WorkerOutOfSpaceException;
  /**
  ...
  void abortUserBlock(long sessionId, long userId, long blockId) throws BlockAlreadyExistsException,
      BlockDoesNotExistException, InvalidWorkerStateException, IOException;
  /**
  ...
  void readSharedBlock(BlockMeta blockMeta, long userId) throws WorkerOutOfSpaceException;
  ...
  void updateBlockSpace(long userId, long blockId, long spaceUsed);

  Map<Long, BlockAccessRecord> getBlockAccessRecords();

  long getTotalCapacityBytes();
  long getTotalAvailableBytes();
  Map<Long, UserStorageInfo> getAllUserStorageInfo();
  void updateUserWeights(Map<Long, Double> weights);
}
