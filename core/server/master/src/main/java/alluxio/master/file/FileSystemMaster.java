...
public interface FileSystemMaster extends Master {
  ...
  void setUserWeight(long userId, Map<Long, Double> workerIdToWeightMap);

  Map<Long, Double> getWorkerWeight(long workerId);

  Map<Long, Double> getUserWeight(long userId);
}
