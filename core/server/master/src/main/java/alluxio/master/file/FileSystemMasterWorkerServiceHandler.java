...
import alluxio.grpc.GetUserWeightsRequest;
import alluxio.grpc.GetUserWeightsResponse;
...
public final class FileSystemMasterWorkerServiceHandler
  ...
  @Override
  public void getUserWeights(GetUserWeightsRequest request,
      StreamObserver<GetUserWeightsResponse> responseObserver) {
    long workerId = request.getWorkerId();
    RpcUtils.call(LOG,
        () -> GetUserWeightsResponse
            .newBuilder().putAllUserWeights(mFileSystemMaster.getWorkerWeight(workerId)).build(),
        "getUserWeights", "workerId=%s", responseObserver, workerId);
  }
