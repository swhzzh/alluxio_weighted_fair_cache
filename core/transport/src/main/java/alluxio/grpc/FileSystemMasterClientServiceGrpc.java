...
public final class FileSystemMasterClientServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<alluxio.grpc.SetUserWeightsRequest,
      alluxio.grpc.SetUserWeightsResponse> getSetUserWeightsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SetUserWeights",
      requestType = alluxio.grpc.SetUserWeightsRequest.class,
      responseType = alluxio.grpc.SetUserWeightsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<alluxio.grpc.SetUserWeightsRequest,
      alluxio.grpc.SetUserWeightsResponse> getSetUserWeightsMethod() {
    io.grpc.MethodDescriptor<alluxio.grpc.SetUserWeightsRequest, alluxio.grpc.SetUserWeightsResponse> getSetUserWeightsMethod;
    if ((getSetUserWeightsMethod = FileSystemMasterClientServiceGrpc.getSetUserWeightsMethod) == null) {
      synchronized (FileSystemMasterClientServiceGrpc.class) {
        if ((getSetUserWeightsMethod = FileSystemMasterClientServiceGrpc.getSetUserWeightsMethod) == null) {
          FileSystemMasterClientServiceGrpc.getSetUserWeightsMethod = getSetUserWeightsMethod = 
              io.grpc.MethodDescriptor.<alluxio.grpc.SetUserWeightsRequest, alluxio.grpc.SetUserWeightsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "alluxio.grpc.file.FileSystemMasterClientService", "SetUserWeights"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  alluxio.grpc.SetUserWeightsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  alluxio.grpc.SetUserWeightsResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new FileSystemMasterClientServiceMethodDescriptorSupplier("SetUserWeights"))
                  .build();
          }
        }
     }
     return getSetUserWeightsMethod;
  }

  private static volatile io.grpc.MethodDescriptor<alluxio.grpc.GetWeightsRequest,
      alluxio.grpc.GetWeightsResponse> getGetWeightsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetWeights",
      requestType = alluxio.grpc.GetWeightsRequest.class,
      responseType = alluxio.grpc.GetWeightsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<alluxio.grpc.GetWeightsRequest,
      alluxio.grpc.GetWeightsResponse> getGetWeightsMethod() {
    io.grpc.MethodDescriptor<alluxio.grpc.GetWeightsRequest, alluxio.grpc.GetWeightsResponse> getGetWeightsMethod;
    if ((getGetWeightsMethod = FileSystemMasterClientServiceGrpc.getGetWeightsMethod) == null) {
      synchronized (FileSystemMasterClientServiceGrpc.class) {
        if ((getGetWeightsMethod = FileSystemMasterClientServiceGrpc.getGetWeightsMethod) == null) {
          FileSystemMasterClientServiceGrpc.getGetWeightsMethod = getGetWeightsMethod = 
              io.grpc.MethodDescriptor.<alluxio.grpc.GetWeightsRequest, alluxio.grpc.GetWeightsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "alluxio.grpc.file.FileSystemMasterClientService", "GetWeights"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  alluxio.grpc.GetWeightsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  alluxio.grpc.GetWeightsResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new FileSystemMasterClientServiceMethodDescriptorSupplier("GetWeights"))
                  .build();
          }
        }
     }
     return getGetWeightsMethod;
  }
  ...
  public static abstract class FileSystemMasterClientServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void setUserWeights(alluxio.grpc.SetUserWeightsRequest request,
        io.grpc.stub.StreamObserver<alluxio.grpc.SetUserWeightsResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getSetUserWeightsMethod(), responseObserver);
    }

    /**
     */
    public void getWeights(alluxio.grpc.GetWeightsRequest request,
        io.grpc.stub.StreamObserver<alluxio.grpc.GetWeightsResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getGetWeightsMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getSetUserWeightsMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                alluxio.grpc.SetUserWeightsRequest,
                alluxio.grpc.SetUserWeightsResponse>(
                  this, METHODID_SET_USER_WEIGHTS)))
          .addMethod(
            getGetWeightsMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                alluxio.grpc.GetWeightsRequest,
                alluxio.grpc.GetWeightsResponse>(
                  this, METHODID_GET_WEIGHTS)))
          .build();
    }
  }
  ...
  public static final class FileSystemMasterClientServiceStub extends io.grpc.stub.AbstractStub<FileSystemMasterClientServiceStub> {
    ...
    public void setUserWeights(alluxio.grpc.SetUserWeightsRequest request,
        io.grpc.stub.StreamObserver<alluxio.grpc.SetUserWeightsResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getSetUserWeightsMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void getWeights(alluxio.grpc.GetWeightsRequest request,
        io.grpc.stub.StreamObserver<alluxio.grpc.GetWeightsResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetWeightsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class FileSystemMasterClientServiceBlockingStub extends io.grpc.stub.AbstractStub<FileSystemMasterClientServiceBlockingStub> {
    ...
    /**
     */
    public alluxio.grpc.SetUserWeightsResponse setUserWeights(alluxio.grpc.SetUserWeightsRequest request) {
      return blockingUnaryCall(
          getChannel(), getSetUserWeightsMethod(), getCallOptions(), request);
    }

    /**
     */
    public alluxio.grpc.GetWeightsResponse getWeights(alluxio.grpc.GetWeightsRequest request) {
      return blockingUnaryCall(
          getChannel(), getGetWeightsMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class FileSystemMasterClientServiceFutureStub extends io.grpc.stub.AbstractStub<FileSystemMasterClientServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<alluxio.grpc.SetUserWeightsResponse> setUserWeights(
        alluxio.grpc.SetUserWeightsRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getSetUserWeightsMethod(), getCallOptions()), request);
    }

    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<alluxio.grpc.GetWeightsResponse> getWeights(
        alluxio.grpc.GetWeightsRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getGetWeightsMethod(), getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_SET_USER_WEIGHTS = 23;
  private static final int METHODID_GET_WEIGHTS = 24;
      ...
      switch (methodId) {
        ...
        case METHODID_UPDATE_UFS_MODE:
          serviceImpl.updateUfsMode((alluxio.grpc.UpdateUfsModePRequest) request,
              (io.grpc.stub.StreamObserver<alluxio.grpc.UpdateUfsModePResponse>) responseObserver);
          break;
        case METHODID_SET_USER_WEIGHTS:
          serviceImpl.setUserWeights((alluxio.grpc.SetUserWeightsRequest) request,
              (io.grpc.stub.StreamObserver<alluxio.grpc.SetUserWeightsResponse>) responseObserver);
          break;
        case METHODID_GET_WEIGHTS:
          serviceImpl.getWeights((alluxio.grpc.GetWeightsRequest) request,
              (io.grpc.stub.StreamObserver<alluxio.grpc.GetWeightsResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (FileSystemMasterClientServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getSetUserWeightsMethod())
              .addMethod(getGetWeightsMethod())
              .build();
        }
      }
    }
