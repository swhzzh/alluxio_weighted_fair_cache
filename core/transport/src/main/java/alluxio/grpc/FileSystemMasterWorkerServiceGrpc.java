...
public final class FileSystemMasterWorkerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<alluxio.grpc.GetUserWeightsRequest,
      alluxio.grpc.GetUserWeightsResponse> getGetUserWeightsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetUserWeights",
      requestType = alluxio.grpc.GetUserWeightsRequest.class,
      responseType = alluxio.grpc.GetUserWeightsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<alluxio.grpc.GetUserWeightsRequest,
      alluxio.grpc.GetUserWeightsResponse> getGetUserWeightsMethod() {
    io.grpc.MethodDescriptor<alluxio.grpc.GetUserWeightsRequest, alluxio.grpc.GetUserWeightsResponse> getGetUserWeightsMethod;
    if ((getGetUserWeightsMethod = FileSystemMasterWorkerServiceGrpc.getGetUserWeightsMethod) == null) {
      synchronized (FileSystemMasterWorkerServiceGrpc.class) {
        if ((getGetUserWeightsMethod = FileSystemMasterWorkerServiceGrpc.getGetUserWeightsMethod) == null) {
          FileSystemMasterWorkerServiceGrpc.getGetUserWeightsMethod = getGetUserWeightsMethod = 
              io.grpc.MethodDescriptor.<alluxio.grpc.GetUserWeightsRequest, alluxio.grpc.GetUserWeightsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "alluxio.grpc.file.FileSystemMasterWorkerService", "GetUserWeights"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  alluxio.grpc.GetUserWeightsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  alluxio.grpc.GetUserWeightsResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new FileSystemMasterWorkerServiceMethodDescriptorSupplier("GetUserWeights"))
                  .build();
          }
        }
     }
     return getGetUserWeightsMethod;
  }
  ...
  public static abstract class FileSystemMasterWorkerServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getUserWeights(alluxio.grpc.GetUserWeightsRequest request,
        io.grpc.stub.StreamObserver<alluxio.grpc.GetUserWeightsResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getGetUserWeightsMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getGetUserWeightsMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                alluxio.grpc.GetUserWeightsRequest,
                alluxio.grpc.GetUserWeightsResponse>(
                  this, METHODID_GET_USER_WEIGHTS)))
          .addMethod(
            getGetUfsInfoMethod(),
            asyncUnaryCall(
              new MethodHandlers<
  ...
  public static final class FileSystemMasterWorkerServiceStub extends io.grpc.stub.AbstractStub<FileSystemMasterWorkerServiceStub> {
    ...
    public void getUserWeights(alluxio.grpc.GetUserWeightsRequest request,
        io.grpc.stub.StreamObserver<alluxio.grpc.GetUserWeightsResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetUserWeightsMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class FileSystemMasterWorkerServiceBlockingStub extends io.grpc.stub.AbstractStub<FileSystemMasterWorkerServiceBlockingStub> {
    ...
    /**
     */
    public alluxio.grpc.GetUserWeightsResponse getUserWeights(alluxio.grpc.GetUserWeightsRequest request) {
      return blockingUnaryCall(
          getChannel(), getGetUserWeightsMethod(), getCallOptions(), request);
    }
  ...
  public static final class FileSystemMasterWorkerServiceFutureStub extends io.grpc.stub.AbstractStub<FileSystemMasterWorkerServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<alluxio.grpc.GetUserWeightsResponse> getUserWeights(
        alluxio.grpc.GetUserWeightsRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getGetUserWeightsMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_GET_USER_WEIGHTS = 3;
  private static final int METHODID_GET_UFS_INFO = 4;
      ...
      switch (methodId) {
        ...
        case METHODID_GET_PINNED_FILE_IDS:
          serviceImpl.getPinnedFileIds((alluxio.grpc.GetPinnedFileIdsPRequest) request,
              (io.grpc.stub.StreamObserver<alluxio.grpc.GetPinnedFileIdsPResponse>) responseObserver);
          break;
        case METHODID_GET_USER_WEIGHTS:
          serviceImpl.getUserWeights((alluxio.grpc.GetUserWeightsRequest) request,
              (io.grpc.stub.StreamObserver<alluxio.grpc.GetUserWeightsResponse>) responseObserver);
          break;
      ...
      synchronized (FileSystemMasterWorkerServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetUserWeightsMethod())
